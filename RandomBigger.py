...
part_a, part_b, part_c = par['a'], par['b'], par['c']

v0 = part_a * part_b * part_c

big_a, big_b, big_c = part_a * (1. + par['bigger_perc']), part_b * (1. + par['bigger_perc']), part_c * (1. + par['bigger_perc'])
            ...
            for part in first_particles:
                ...
                if rotation == 0:
                    ...
                    if part_rot == 0:
                        ...
                        if dist_x <= big_a and dist_y * m.cos(theta) <= big_b:

                            overlap = True

                    else:

                        if dist_x <= 0.5 * (big_a + big_b) and dist_y * m.cos(theta) <= 0.5 * (big_a + big_b):
                    ...
                    if part_rot == 0:
                        ...
                        if dist_x <= big_b and dist_y * m.cos(theta) <= big_a:
    ...
    with open(ofile, "w") as fl:
        ...
        for n_p in range(int(N)):
            ...
            if part_r[n_p][3] == 0:
                ...
                fl.write(f"BOX {part_a} {part_b} {part_c} {part_r[n_p][0]} {part_r[n_p][1]} {part_r[n_p][2]} {R[0][0]} {R[0][1]} {R[0][2]} {R[1][0]} {R[1][1]} {R[1][2]} {R[2][0]} {R[2][1]} {R[2][2]}\n")

            else:
                
                fl.write(f"BOX {part_b} {part_a} {part_c} {part_r[n_p][0]} {part_r[n_p][1]} {part_r[n_p][2]} {R[0][0]} {R[0][1]} {R[0][2]} {R[1][0]} {R[1][1]} {R[1][2]} {R[2][0]} {R[2][1]} {R[2][2]}\n")
